...
const ExternalChecks = ({ phone }: { phone: string }) => {
  ...
  const services = [
    { name: 'Num Baster', icon: 'Search', url: `https://numbuster.com/ru_RU/number/+${intl}`, color: 'text-primary', bg: 'bg-primary/15' },
    ...
    { name: 'Бот в Telegram', icon: 'Send', url: 'https://t.me/thecratorsbot', color: 'text-[#229ED9]', bg: 'bg-[#229ED9]/15' },
  ];
  return (
    <div className="mt-4">
